import { animate } from "./lib/amator.js";
import { eventify } from "./lib/events.js";
import { makeTextSelectionInterceptor } from './lib/makeTextSelectionInterceptor.js'
 ...
 *
 * @param {HTMLElement} domElement where panzoom should be attached.
...
export function createPanZoom(domElement, options) {
  ...
  if (initialX != transform.x || initialY != transform.y || initialZoom != transform.scale) {
    ...
    console.log("INIT", initialY, initialX, initialZoom)
  }
